...
int main() {
    ...
    matrix_t* p_sum_matrix = calculate_sum_matrix(p_matrix_a, p_matrix_b);
    if(p_sum_matrix != NULL) {
        printf("matrix_t A + matrix_t B: \n");
        print_matrix(p_sum_matrix);
    }
    else {
        printf("matrix_t A, matrix_t B can not add together\n");  
    }
